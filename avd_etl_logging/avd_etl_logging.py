"""
Packageable library for the logger class seen in ETL processes. See README for more.
...
# Class that executes code that etl processes use for logging across processes
